...
Sludge::Sludge(std::string name, int age, int x, int y, char repr) : Person(name, age, x, y, repr)
{
    this->xp_value = 100;
    this->cls_name = "Sludge";
    // this->name = name;
    // this->age = age;
    // this->x = x;
    // this->y = y;
    ...
    this->attrs->health->max_val = 130;
    this->attrs->health->current_val = 130;

    this->attrs->damage->max_val = 10;
