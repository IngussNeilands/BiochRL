...
template Troll* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Jackal* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Skeleton* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Ogre* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template BadMother* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template HulkingMantis* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Idol* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Imp* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template MutantFish* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template SpinyLizard* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template CrazedCook* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Wildling* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Sludge* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
template Jumper* Game::spawn_creature(Room* room, std::string name, int age, char repr, Map* world);
