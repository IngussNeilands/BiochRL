...
MutantFish::MutantFish(std::string name, int age, int x, int y, char repr) : Person(name, age, x, y, repr)
{
    ...
    this->img_path = get_data_path()+"img/mutantfish8x8.png";
    ...
    this->attrs->health->max_val = 50;
    this->attrs->health->current_val = 50;

    this->attrs->damage->max_val = 8;
